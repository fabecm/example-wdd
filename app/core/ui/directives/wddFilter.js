    ...
    return {
        ...
        link: (scope) => {
            ...
            scope.checkTextTyped = () => {
                ...
                return (scope.filtersArray.length > 0 && filtered.length === scope.filtersArray.length) || scope.values.processOwnerChosen.value !== -1 || scope.values.systemOwnerChosen.value !== -1;
            };
